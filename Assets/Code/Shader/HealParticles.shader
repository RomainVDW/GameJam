	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 lerpResult13 = lerp( _DarkColor , _LightColor , tex2D( _HealTex, uv_HealTex ).r);
...
ASEEND*/
//CHKSM=6BB9388111FC5CA2B2806E368457FF3053984D14